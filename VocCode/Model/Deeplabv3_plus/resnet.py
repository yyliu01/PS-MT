...
def resnet50(pretrained_model=None, **kwargs):
    ...
    if pretrained_model is True:
        pretrained_model = 'VocCode/Model/Deeplabv3_plus/Backbones/pretrained/resnet50.pth'
...
def resnet101(pretrained_model=None, **kwargs):
    ...
    if pretrained_model is True:
        pretrained_model = 'VocCode/Model/Deeplabv3_plus/Backbones/pretrained/resnet101.pth'
